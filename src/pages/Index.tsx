...
const Index = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-background paper-texture flex items-center justify-center px-6 sm:px-12 py-12 transition-all ${exiting ? 'animate-page-exit' : 'animate-page-enter'}`}
    >
      <div className="relative z-10 w-full max-w-[480px]">
        {/* Header */}
        <div className="text-center mb-2">
          {/* TODO: 引入Ma Shan Zheng书法字体 */}
          <h1 className="font-serif text-5xl tracking-[0.3em] text-foreground">
            爻光
          </h1>
        </div>
        <p className="text-sm text-muted-foreground tracking-widest text-center mb-10">
          赛博黄历 · 每日一爻
        </p>

        {/* Card */}
        <div className="bg-card rounded shadow-subtle border border-border p-8 space-y-6">
          {returning && (
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full h-12 rounded-sm bg-primary text-primary-foreground font-serif text-base tracking-wider hover:bg-primary-hover transition-colors btn-press disabled:opacity-40 disabled:cursor-not-allowed"
            >
              查看今日运势
            </button>
          </div>
